...
import doancnpm.payload.response.MyFileNotFoundException;
...
public class FileStorageService {
    ...
    public FileStorageService(FileStorageProperties fileStorageProperties) throws IOException {
    	...
    	//Path CURRENT_FOLDER = Paths.get(System.getProperty("user.dir")+fileStorageProperties.getUploadDir());
...
//        }
        ...
        this.fileStorageLocation = Paths.get(System.getProperty("user.dir")+fileStorageProperties.getUploadDir())
